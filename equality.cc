...
bool Equals<EqualityCache>::operator()(Id id1, Id id2) {
...
template <typename EqualityCache>
bool Equals<EqualityCache>::operator()(const std::vector<Id>& ids1,
...
bool Equals<EqualityCache>::operator()(const std::map<Key, Id>& ids1,
...
template <typename EqualityCache>
bool Equals<EqualityCache>::operator()(const Void&, const Void&) {
  return true;
}

template <typename EqualityCache>
bool Equals<EqualityCache>::operator()(const Variadic&, const Variadic&) {
  return true;
}

template <typename EqualityCache>
bool Equals<EqualityCache>::operator()(const PointerReference& x1,
...
template <typename EqualityCache>
bool Equals<EqualityCache>::operator()(const Typedef& x1, const Typedef& x2) {
  return x1.name == x2.name
      && (*this)(x1.referred_type_id, x2.referred_type_id);
}

template <typename EqualityCache>
bool Equals<EqualityCache>::operator()(const Qualified& x1,
                                       const Qualified& x2) {
...
template <typename EqualityCache>
bool Equals<EqualityCache>::operator()(const Primitive& x1,
                                       const Primitive& x2) {
  return x1.name == x2.name
...
template <typename EqualityCache>
bool Equals<EqualityCache>::operator()(const Array& x1, const Array& x2) {
  return x1.number_of_elements == x2.number_of_elements
      && (*this)(x1.element_type_id, x2.element_type_id);
}

template <typename EqualityCache>
bool Equals<EqualityCache>::operator()(const BaseClass& x1,
                                       const BaseClass& x2) {
...
template <typename EqualityCache>
bool Equals<EqualityCache>::operator()(const Member& x1, const Member& x2) {
  return x1.name == x2.name
      && x1.offset == x2.offset
      && x1.bitsize == x2.bitsize
      && (*this)(x1.type_id, x2.type_id);
...
template <typename EqualityCache>
bool Equals<EqualityCache>::operator()(const Method& x1, const Method& x2) {
...
template <typename EqualityCache>
bool Equals<EqualityCache>::operator()(const StructUnion& x1,
                                       const StructUnion& x2) {
...
template <typename EqualityCache>
bool Equals<EqualityCache>::operator()(const Enumeration& x1,
                                       const Enumeration& x2) {
  const auto& definition1 = x1.definition;
  const auto& definition2 = x2.definition;
...
template <typename EqualityCache>
bool Equals<EqualityCache>::operator()(const Function& x1, const Function& x2) {
  return (*this)(x1.parameters, x2.parameters)
      && (*this)(x1.return_type_id, x2.return_type_id);
}

template <typename EqualityCache>
bool Equals<EqualityCache>::operator()(const ElfSymbol& x1,
                                       const ElfSymbol& x2) {
...
template <typename EqualityCache>
bool Equals<EqualityCache>::operator()(const Symbols& x1, const Symbols& x2) {
  return (*this)(x1.symbols, x2.symbols);
}

template <typename EqualityCache>
bool Equals<EqualityCache>::Mismatch() {
  return false;
}
